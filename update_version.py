...
def main():
  ...
  plistpath = scriptpath + "/resources/MyFirstGraphicPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstGraphicPlugin-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstGraphicPlugin-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstGraphicPlugin-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstGraphicPlugin-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstGraphicPlugin-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MyFirstGraphicPlugin-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MyFirstGraphicPlugin.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MyFirstGraphicPlugin.iss",inplace=1):
